window.onload = function(){
    ...
    platina.value = localStorage.getItem(parseInt("plat",2));
    ouro.value = localStorage.getItem(parseInt("ouro",2));
    prata.value = localStorage.getItem(parseInt("prata",2));
    bronze.value = localStorage.getItem(parseInt("bronze",2));
}
