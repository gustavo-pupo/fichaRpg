window.onload = function(){
    ...
    platina.value = localStorage.getItem(parseInt("plat"));
    ouro.value = localStorage.getItem(parseInt("ouro"));
    prata.value = localStorage.getItem(parseInt("prata"));
    bronze.value = localStorage.getItem(parseInt("bronze"));
}
